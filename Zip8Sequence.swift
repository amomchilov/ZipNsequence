...
/// Creates a sequence of tuples built out of 8 underlying sequences.
///
/// In the `Zip8Sequence` instance returned by this function, the elements of
...
///     // Prints "four: 4"
///
/// If the 8 sequences passed to `zip(_:_:_:_:_:_:_:_:)` are different lengths, the
...
/// An iterator for `Zip8Sequence`.
public struct Zip8Iterator<
...
///
/// In a `Zip8Sequence` instance, the elements of the *i*th pair are the *i*th
/// elements of each underlying sequence. To create a `Zip8Sequence` instance,
/// use the `zip(_:_:_:_:_:_:_:_:)` function.
///
...
>
  ...
  /// sequence, in order.
  public typealias Iterator = Zip8Iterator<
    Stream1,
    Stream2,
    Stream3,
    Stream4,
